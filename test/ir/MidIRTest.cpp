...
TEST_F(MidIRTest, BuildMNISTGraph) {
    ...
    auto* x = builder.createInput("x", sandy::ir::Shape({-1, 784}), sandy::ir::DType::F32);
    auto* w1 = builder.createWeight("fc1.weight", sandy::ir::Shape({128, 784}), sandy::ir::DType::F32);
    auto* b1 = builder.createWeight("fc1.bias", sandy::ir::Shape({128}), sandy::ir::DType::F32);
    auto* l1 = builder.createLinear(x, w1, b1);
    auto* r1 = builder.createReLU(l1);
    auto* w2 = builder.createWeight("fc2.weight", sandy::ir::Shape({10, 128}), sandy::ir::DType::F32);
    auto* b2 = builder.createWeight("fc2.bias", sandy::ir::Shape({10}), sandy::ir::DType::F32);
...
TEST_F(MidIRTest, LinearTypeInference) {
    ...
    auto* x = builder.createInput("x", sandy::ir::Shape({-1, 784}), sandy::ir::DType::F32);
    auto* w = builder.createWeight("w", sandy::ir::Shape({128, 784}), sandy::ir::DType::F32);
    auto* b = builder.createWeight("b", sandy::ir::Shape({128}), sandy::ir::DType::F32);
    auto* out = builder.createLinear(x, w, b);

    EXPECT_EQ(out->shape.rank(), 2);
    EXPECT_EQ(out->shape.dim(0), -1);
    EXPECT_EQ(out->shape.dim(1), 128);
    EXPECT_EQ(out->dtype, sandy::ir::DType::F32);
}
...
TEST_F(MidIRTest, ReLUTypeInference) {
    ...
    auto* x = builder.createInput("x", sandy::ir::Shape({4, 128}), sandy::ir::DType::F32);
...
TEST_F(MidIRTest, InputWeightAttrs) {
    ...
    auto* x = builder.createInput("x", sandy::ir::Shape({1, 784}), sandy::ir::DType::F32);
    auto* w = builder.createWeight("fc1.weight", sandy::ir::Shape({128, 784}), sandy::ir::DType::F32);
