...
- **Compiler and kernels from scratch.** Sandy lowers through multi-level IRs into hand-written CUDA kernels (paged attention, MoE gather/scatter, RoPE, norms, top-k) JIT-compiled by NVRTC. cuBLAS is used only for dense matmuls.
