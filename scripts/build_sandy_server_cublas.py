...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Build Sandy server with CPU execution and cuBLAS-backed CPU matmul."
    )
    parser.add_argument("--build-dir", default=root / "build-server-cublas", type=pathlib.Path)
    parser.add_argument(
        "--grpc-prefix",
        type=pathlib.Path,
    ...
    configure_cmd = [
        ...
        "-DSANDY_ENABLE_CUDA=OFF",
        "-DSANDY_MATMUL_CUBLAS=ON",
