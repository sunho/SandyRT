...
func main(input_id Tensor[[1, -1], i64], position_id Tensor[[1], i64], local_k_cache [25]PagedTensor[[1, 8, -1, 256], bf16, page_size=32], local_v_cache [25]PagedTensor[[1, 8, -1, 256], bf16, page_size=32], global_k_cache [5]PagedTensor[[1, 2, -1, 512], bf16, page_size=32], global_v_cache [5]PagedTensor[[1, 2, -1, 512], bf16, page_size=32]) Tensor {
