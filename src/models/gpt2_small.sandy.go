func gpt2_attention(x Tensor) Tensor {
    weight_scope "attn" {
...
func gpt2_block(x Tensor, i int) Tensor {
    weight_scope "h.{i}" {
...
func main(input_ids Tensor, position_ids Tensor) Tensor {
